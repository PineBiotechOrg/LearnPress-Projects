    ...
    var Checkout = LP.Checkout = function (options) {
        ...
        var _formSubmit = function (e) {
            ...
            var $form = $payments.children('.selected'),
                $buttonCheckout = $( this ).find('#learn-press-checkout-place-order'),
            ...
            $buttonCheckout.prop('disabled', true).addClass('loading');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    try {
                        ...
                        $buttonCheckout.prop('disabled', false).removeClass('loading');
                        LP.unblockContent();
                    }
                },
