...
$tab      = get_query_var( 'projects_tab', $atts['tab'] );
$args     = get_omics_tabs( array( 'limit' => $limit, 'tab' => $tab ) );
...
<?php if ( $total == 0 ) : ?>
    ...
    <?php }?>
    <div id="lp-project-archive" class="thim-course-list" data-cookie="list-layout">
        <?php echo $message; ?>
    </div>
<?php else: ?>
